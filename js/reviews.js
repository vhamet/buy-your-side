const reviews = [
  {
    ...
    location: "Paris",
    review:
      "Stéphanie m’a accompagnée dans mon projet de recherche d’appartement à Paris pour un investissement locatif : compétence et dévouement sont les maîtres mots caractérisant le professionnalisme dont elle a fait preuve tout au long de notre collaboration ; enfin, sa gentillesse et sa bienveillance rendent encore plus incontournable de faire appel à elle pour un projet de recherche d’appartement, bref je la recommande mille fois !",
  },
  {
    name: "Maryam",
